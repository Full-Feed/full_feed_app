        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: SizedBox(
                width: size.width/2,
                child: Text(UserSession().rol == "p" ? "A partir de mañana comienza una nueva vida saludable" :
                "Los pacientes esperan por tu asesoramiento.", style: TextStyle(fontSize: 16), textAlign: TextAlign.center,),
              ),
            ),
            Padding(
                padding: EdgeInsets.only(top: size.height/20),
